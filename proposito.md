...
* **`portugues.html`**: Guía interactiva de 30 frases esenciales en portugués de Brasil.
* **`ingles.html`**: Guía interactiva de 30 frases esenciales en inglés (`en-US`).

---

**Funcionalidades y Características Actuales**

* **Contenido de las guías (30 frases por idioma):**
